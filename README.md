...
| openjdk:21-jdk-slim: not found   | Invalid tag                  | Use eclipse-temurin:21-jdk-jammy         |
| TLS handshake timeout            | Network/Docker Hub           | Retry or restart Docker                  |
| docker build missing .           | Syntax error                 | Use docker build -t name .               |
